    ...
    <div class="">
      ...
      <ul class="grid md:grid-cols-2 lg:grid-cols-1 gap-7">
        ...
        <li class="flex items-center gap-3">
          ...
          <div class="flex flex-col text-start">
            ...
            <a href="mailto:richard@example.com" class="tracking-wide"
              >shuxratovjavohir4.com</a
            >
          </div>
        </li>
        <!-- 2 -->
        ...
        <li class="flex flex-center gap-3">
          ...
          <div class="flex flex-col text-start">
            <p class="uppercase text-xs font-semibold text-gray-400">Birthday</p>
        ...
        <li class="flex items-center gap-3">
          ...
          <div class="flex flex-col text-start">
            <p class="uppercase text-xs font-semibold text-gray-400">Location</p>
      ...
      <ul class="flex justify-center gap-3 mt-7">
        <li class="text-gray-400 hover:text-white transition">
          <a href="https://www.facebook.com/profile.php?id=61553756199321" class="social-link"
