    ...
    <section class="">
      ...
      <div class="">
        <ul class="space-x-5 mb-6">
            ...
            <div class="relative">
              ...
              >
                <p>
                  ...
                  clean and with a beautiful design that got a lot of praises
                  from colleagues and visitors. We were very pleased with the
                  work done. He has a lot of experience and is very concerned
          ...
          <li class="bg-[#262424] rounded-2xl p-5 bg-gradient-to-br from-neutral-700/100 via-gray-700/0 via-50% cursor-pointer hover:shadow-lg hover:scale-105 transition duration-300">
            <div class="relative" data-testimonials-item>
              <figure class="">
                <img
              ...
              >
                <p>
                  ...
                  only visually appealing but also optimized for conversions.
                  I've seen a 50% increase in traffic since the launch!
                </p>
              </div>
            </div>
          </li>
